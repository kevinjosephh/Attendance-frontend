...
class Course_fetch_listTile_widget extends StatelessWidget {
  final singleObj;
  const Course_fetch_listTile_widget({super.key, required this.singleObj});
  ...
  tile_subtitle() {
    return Column(
      ...
      children: [
        Text(
          singleObj.start_date+' '+singleObj.end_date,
          maxLines: 1,
        ),
        // SizedBox(
        //   height: 80,
