...
// class Teacher_register_delete_button extends StatelessWidget {
//   final singleObj;
//   const Teacher_register_delete_button({super.key, required this.singleObj});
...
//         if (state is Teacher_Delete_Loaded_state) {
//           MyComponents.successSnackBar(context, 'Action completed');
//           Navigator.pop(context);
//         } else if (state is Teacher_Delete_Error_State) {
...
//         } else if (state is Teacher_Delete_Loading_state) {
...
//             state is Teacher_update_Loading_State) {
...
//         .add(Teacher_Delete_onButtonPressed_Event(singleObj!.id));
//   }
// }
