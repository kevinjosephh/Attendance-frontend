...
import 'Teacher_register_save_button.dart';
import 'Teacher_register_update_button.dart';

class Teacher_register_form_widget extends StatelessWidget {
  final singleObj;
  final formKey;
  final firstName;
  final lastName;
  ...
  const Teacher_register_form_widget({
    super.key,
            ...
            child: Column(
              children: [
                ...
                singleObj == null
                    ...
                    : Teacher_register_update_button(
                        formKey: formKey,
                        singleObj: singleObj,
                      )
              ],
