...
import 'User_register_form/User_register_delete_button.dart';
import 'User_register_form/User_register_form_widget.dart';
...
class User_register_screen extends StatefulWidget {
  ...
  User_register_screen({this.singleObj});
  User_register_screen.named(this.singleObj);

  @override
  _User_register_screenState createState() => _User_register_screenState();
}
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: User_register_form_widget(
    ...
    return AppBar(
      ...
      title: Text(
        widget.singleObj != null
            ? "Update"
            : "ADD STUDENT", //give here appBar title
        style: TextStyle(
